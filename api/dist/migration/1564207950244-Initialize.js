...
class Initialize1564207950244 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query("CREATE TABLE `building` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `title` varchar(255) NOT NULL, `hash` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
...
exports.Initialize1564207950244 = Initialize1564207950244;
//# sourceMappingURL=1564207950244-Initialize.js.map